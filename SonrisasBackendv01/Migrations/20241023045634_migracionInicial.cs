        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Odontologos_Consultorios_ConsultorioId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NuevoPaciente = table.Column<int>(type: "int", nullable: false),
                    PacienteRecomendado = table.Column<int>(type: "int", nullable: false),
                    ...
                    RutaLocalImagen = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    Telefono = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Direccion = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pacientes_Odontologos_OdontologoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Odontologos_ConsultorioId",
                table: "Odontologos",
